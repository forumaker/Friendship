...
return [
    ...
    (new Extend\Settings())
        ...
        ->default('forumaker-friendship.badge_color', '#45698D')
        ->default('forumaker-friendship.badge_bg_color', '#45698D')
        ->default('forumaker-friendship.badge_icon', 'fas fa-hand-peace')
